...
LoacPage = function (a) {
	...
	e[a] || (a = "index"), $("[item_identifier=" + $("#url").val() + "]").removeClass("current"), $("[item_identifier=" + a + "]").addClass("current"), a) {
        case "download":
        ...
        case "member":
            ...
            break;
        case "gf_forum":
            $(".main").load("views/gf_view.htm",
            function () {
                LoadAjaxData(GetForum)
            }),
            $(".footer").css("position", "static");
        default:
            $(".main").load("views/gf_view.htm",
